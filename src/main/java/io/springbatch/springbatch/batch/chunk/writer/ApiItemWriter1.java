...
public class ApiItemWriter1 extends FlatFileItemWriter<ApiReqeustVO>
{
    ...
    public void write(List<? extends ApiReqeustVO> list) throws Exception
    {
        ...
        super.setResource(new FileSystemResource("C:\\GIT\\learningSB\\spring-batch\\src\\main\\resources\\product1.txt"));
